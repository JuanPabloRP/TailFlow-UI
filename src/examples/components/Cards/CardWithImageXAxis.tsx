import image from '../../../assets/img/imageXAxis.avif';

const CardWithImageXAxis = () => {
	return (
		<article
			className={`flex max-w-sm border border-neutral-200 
      hover:border-neutral-300 dark:border-neutral-800 rounded-lg  dark:bg-neutral-950 dark:hover:border-neutral-700 transition-all ease-in-out  dark:text-white  `}
		>
			<figure className="">
				<img src={image} alt="" className="rounded-l-md object-cover " />
			</figure>
...
export default CardWithImageXAxis;
