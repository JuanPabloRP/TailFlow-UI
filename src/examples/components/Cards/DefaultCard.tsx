const DefaultCard = () => {
	return (
		<article
			...
			hover:border-neutral-300 dark:border-neutral-800 rounded-md p-3 dark:bg-neutral-950 hover:bg-neutral-100/70 
      dark:hover:bg-neutral-900 dark:hover:border-neutral-700 transition-all ease-in-out  dark:text-white `}
		>
